...
function passwordStrength(password: string) {
  if (!password) {
    return { pct: 0, label: "", barClass: "bg-muted", textClass: "text-muted-foreground" };
  }
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                disabled={loading}
                className="focus-visible:ring-primary pr-11 pl-10"
              />
              <button
                type="button"
          ...
          <div className="flex items-start gap-3">
            <Checkbox
              ...
              className="mt-0.5"
            />
            <Label htmlFor="terms" className="text-muted-foreground cursor-pointer text-sm font-normal leading-snug">
              I agree to the{" "}
